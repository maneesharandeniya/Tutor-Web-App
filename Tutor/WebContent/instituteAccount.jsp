                        ...
                        <div class="profile-head">
                                    <%try
						 			...
						 			Connection con = ConnectionProvider.getCon();
						  			...
						  			ResultSet rs = st.executeQuery("SELECT * FROM Tutor.Institute WHERE Institute.Institute_Email = '"+email+"'");
						  			rs.next();
					 				%>
                                    <h5>
                                        <%=rs.getString(2)%>
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                              <div>
								   ...
								   <ul><div>
									    <%@page import="java.sql.*" %>
					      				...
					      				<%try
					      				{
						    	 			Connection con = ConnectionProvider.getCon();
						   	  				Statement st = con.createStatement();
						   	  			    String email = (String)session.getAttribute("instituteEmail");
						   	  			    ResultSet rs1 = st.executeQuery("SELECT Institute.Institute_Name,Subject.Subject_Name ,Institute_Ad.Teacher_Name, Institute.Contact_Number, Institute_Ad.Area, Institute_Ad.Description,Subject.Stream,Subject.Medium,Institute_Ad.Area,Subject.Subject_ID FROM Subject,Institute,Institute_Ad WHERE Institute_Ad.Subject_ID = Subject.Subject_ID and Institute.Institute_ID = Institute_Ad.Institute_ID and Institute.Institute_Email = '"+email+"' ");
					    	  			    while(rs1.next()){
					      				%>
								    	<li><div>
									    ...
									    <div style="text-align:right;"> <a href="instituteUpdateAd.jsp?SID=<%=rs1.getString(10) %> " class="loginhere-link">Edit</a>
									        <a href="instituteDeleteAd.jsp?SID=<%=rs1.getString(10) %>" class="loginhere-link">  Delete</a> </div>
								     	<%}}
				                     	catch(Exception e){}%> 
