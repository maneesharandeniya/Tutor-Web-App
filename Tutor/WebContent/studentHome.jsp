            ...
            <div>
				   ...
				   <ul><div>
	      				...
	      				<%try
	      				{
		    	 			Connection con = ConnectionProvider.getCon();
		   	  				Statement st = con.createStatement();		   	  			   
		    	  			ResultSet rs = st.executeQuery("SELECT Subject.Subject_Name ,Teacher.Teacher_Name,Teacher_Ad.Contact_Number,Teacher_Ad.Area,Teacher_Ad.Description,Subject.Stream,Subject.Medium from Subject,Teacher,Teacher_Ad where Teacher_Ad.Subject_ID = Subject.Subject_ID and Teacher.Teacher_ID = Teacher_Ad.Teacher_ID ");
		    	  			while(rs.next()){
	      				%>
				    	<li><div>
					    ...
					    <%try
	      				{
		    	 			Connection con = ConnectionProvider.getCon();
		   	  				Statement st = con.createStatement();
		   	  			    ResultSet rs1 = st.executeQuery("SELECT Institute.Institute_Name,Subject.Subject_Name ,Institute_Ad.Teacher_Name, Institute.Contact_Number, Institute_Ad.Area, Institute_Ad.Description,Subject.Stream,Subject.Medium,Institute_Ad.Area from Subject,Institute,Institute_Ad where Institute_Ad.Subject_ID =  Subject.Subject_ID and Institute.Institute_ID = Institute_Ad.Institute_ID ");
