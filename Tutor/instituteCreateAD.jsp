    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" action = "instituteAdAction.jsp">
                                    ...
                                    <%try
				      				{
					    	 			Connection con = ConnectionProvider.getCon();
					    	  			...
					    	  			ResultSet rs = st.executeQuery("SELECT Institute.Institute_Name FROM Tutor.Institute WHERE Institute.Institute_Email = '"+name+"'");
					    	  			rs.next();
				      				%>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="tutor" placeholder="Tutor Name" required = "required">
                                </div>
                            </div>
                        </div>
                                     ...
                                     <%try
						      				{
							    	 			Connection con = ConnectionProvider.getCon();
							    	  			...
							    	  			ResultSet rs = st.executeQuery("SELECT Institute.Contact_Number FROM Tutor.Institute WHERE Institute.Institute_Email = '"+email+"'");
							    	  			rs.next();
						      				%>
                                          <input class="input--style-5" disabled="disabled" type="text" name="phone" value="<%=rs.getString(1) %>" required = "required">                                            
                                     <%}
                            	     catch(Exception e){}%> 
                                     </div>
                                </div>                              
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="areas" placeholder="location of the class" required = "required">
                                </div>
                            </div>
                        </div>
