                        ...
                        <div class="profile-head">
                                    <%try
						 			...
						 			Connection con = ConnectionProvider.getCon();
						  			...
						  			ResultSet rs = st.executeQuery("SELECT * FROM Tutor.Teacher WHERE Teacher.Teacher_Email = '"+email+"'");
						  			rs.next();
					 				%>
                                    <h5>
                                        <%=rs.getString(2)%>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">My Ads</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                              <div>
								   ...
								   <ul><div>
									    <%@page import="java.sql.*" %>
					      				...
					      				<%try
					      				{
						    	 			Connection con = ConnectionProvider.getCon();
						   	  				Statement st = con.createStatement();
						   	  			    String email = (String)session.getAttribute("userEmail");
						    	  			ResultSet rs = st.executeQuery("SELECT Subject.Subject_Name ,Teacher.Teacher_Name,Teacher_Ad.Contact_Number,Teacher_Ad.Area,Teacher_Ad.Description,Subject.Stream,Subject.Medium,Teacher_Ad.Teacher_ID,Subject.Subject_ID FROM Subject,Teacher,Teacher_Ad WHERE Teacher_Ad.Subject_ID = Subject.Subject_ID and Teacher.Teacher_ID = Teacher_Ad.Teacher_ID and Teacher.Teacher_Email = '"+email+"'");
						    	  			while(rs.next()){
					      				%>
								    	<li><div>
									    ...
									    <div style="text-align:right;"> <a href="teacherUpdateAd.jsp?SID=<%=rs.getString(9) %> " class="loginhere-link">Edit</a>
									        <a href="teacherDeleteAd.jsp?SID=<%=rs.getString(9) %>" class="loginhere-link">  Delete</a> </div>
								     	<%}}
				                     	catch(Exception e){}%> 
