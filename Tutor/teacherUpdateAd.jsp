    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" action = "teacherUpdateAdAction.jsp">
                                    ...
                                    <%try
				      				{
					    	 			Connection con = ConnectionProvider.getCon();
					    	  			...
					    	  			ResultSet rs2 = st2.executeQuery("SELECT Teacher.Teacher_Name,Subject.Subject_Name,Teacher_Ad.Contact_Number,Teacher_Ad.Area ,Teacher_Ad.Description,Subject.Stream,Subject.Medium FROM Tutor.Teacher,Tutor.Subject,Tutor.Teacher_Ad WHERE Teacher.Teacher_ID = '"+TID+"' and Subject.Subject_Id='"+SID+"' and Teacher_Ad.Teacher_ID = '"+TID+"' and Teacher_Ad.Subject_Id='"+SID+"'");
					    	  			rs2.next();
				      				%>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">                                                               
                               	<div class="input-group">
                                     <div class="input-group">
                                          <input class="input--style-5" type="text" name="phone" value="<%=rs2.getString(3) %>" required = "required">                                            
                                     </div>
                                </div>                              
                           </div>
                        </div>
                        ...
                        <div style="text-align:left;" class = "work">
                             <a href="teacherAccount.jsp " class="loginhere-link">Back</a>									         
					    </div>
                    </form>
                </div>
            </div>
